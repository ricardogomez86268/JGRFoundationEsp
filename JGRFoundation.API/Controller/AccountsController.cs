...
namespace JGRFoundation.API.Controllers
{
    [ApiController]
    [Route("/api/accounts")]
    public class AccountsController : ControllerBase
    {
        ...
        public async Task<ActionResult> CreateUser([FromBody] UserDTO model)
        {
            ...
            if (result.Succeeded)
            {
                ...
                var response = _mailHelper.SendMail(user.FullName, user.Email!, 
                    $"Homess- Confirmación de cuenta", 
                    $"<h1>JGRFoundation - Confirmación de cuenta</h1>" +
        ...
        public async Task<ActionResult> RecoverPassword([FromBody] EmailDTO model)
        {
            ...
            var response = _mailHelper.SendMail(user.FullName, user.Email!,
                $"JGRFoundation - Recuperación de contraseña",
                $"<h1>JGRFoundation - Recuperación de contraseña</h1>" +
